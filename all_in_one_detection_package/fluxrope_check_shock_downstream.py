...
#datetimeStart_str = sys.argv[1]
#datetimeEnd_str = sys.argv[2]

'''
datetimeStart_str = '200401220000'
datetimeEnd_str   = '200401221000'
shockTimeList = [datetime(2004,1,22,1,4)]
'''

'''
datetimeStart_str = '200201310000' 
datetimeEnd_str   = '200202020000'
shockTimeList = [datetime(2002,1,31,21,38)] # for WIND
'''

ID_dict = {'a':'ACE', 'w':'WIND'}

# Specify spacecraft.
spacecraftID = ID_dict['w'] # 'ACE' or 'WIND'.

shockTimeList = [datetime(1999,3,10,1,33,0)]
#shockTimeList = [datetime(2003,12,7,13,41,0)]
#shockTimeList = []
...
# 3) Detect flux ropes.
if isSearch:
    # if n_theta_grid=12, d_theta_deg = 90/12 = 7.5, d_phi_deg = 360/24 = 15. If n_theta_grid=9, d_theta_deg = 90/9 = 10
...
if isCombineRawReslut:
    ...
    # Debug.
    #result_raw_dict_temp = pickle.load(open(search_result_raw_filename, 'rb'))
    #print(result_raw_dict_temp)
